...
import { Search, Plus, Mail, Phone, MapPin, Edit, Trash2, Star, Loader } from 'lucide-react';
import { 
  getAllCustomers, 
  addCustomer, 
  deleteCustomer,
...
export default function CustomersFirebase() {
  ...
  const handleAddCustomer = async (e: React.FormEvent) => {
    ...
    if (id) {
      setCustomers([{ ...newCustomer, id }, ...customers]);
    ...
    <div className="space-y-6">
      ...
      {filteredCustomers.length === 0 && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          <p className="text-gray-500">لا يوجد عملاء. ابدأ بإضافة عميل جديد!</p>
        </div>
      )}
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">{customer.totalSpent} د.م</p>
              </div>
            </div>
